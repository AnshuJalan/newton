...
class Dashboard extends Component {
  ...
  componentDidMount = async () => {
    try {
      ...
      const instance = new web3.eth.Contract(CallOptionContract.abi, address);
  ...
  render() {
    if (
      !this.state.loading &&
      (this.state.web3 == null || this.state.networkId != 4)
    ) {
      return (
        <div className='mt-5 text-center container'>
          <h1 className='text-white'>
            Please connect your Metamask wallet, and switch over to Rinkeby
            network.
          </h1>
      ...
      return (
        <div className='loader container text-white text-center'>
          ...
          <span>
            ...
            <img width='36' src={require('./images/meta.png')} />
          </span>
        </div>
      );
    }
