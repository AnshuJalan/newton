...
class Wallet extends Component {
    ...
    updateWallet = async () => {
        ...
        let dai = await this.state.contract.methods.balanceOf(this.state.accounts[0]).call();
        ...
        return (
            <div className="sec-bg wallet text-white">
                <div class="input-box-header text-center">
                    <img className="ml-2 mb-1" src={require('../images/meta.png')} width="24" />  Wallet
                </div>
                <table className="w-100">
                    <tbody>
                        <tr>
                            <td className="text-center"><img src={require('../images/eth.png')} width="36" /></td>
                            <td>{this.state.eth}</td>
                            <td className="text-center"><img src={require('../images/dai.png')} width="36" /></td>
